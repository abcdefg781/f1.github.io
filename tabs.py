...
class dataContainer:
	def __init__(self):
		self.race_table,self.year_races,self.color_palette,self.colored_df = create_race_table(2021, "French Grand Prix")
			...
			[
				...
				dbc.Tab(label="Race Analysis", tab_id="raceanalysis", children = [
						...
						dbc.Row([
							...
							dbc.Col(
								dcc.Dropdown(className='div-for-dropdown',id='race_name',value='French Grand Prix',clearable=False)
							)
						]),
						dbc.Row([
							dbc.Col(
