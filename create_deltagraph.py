...
race_table,races_temp,color_palette,color_df = create_race_table(2021,'Emilia Romagna Grand Prix')
print(color_df)
def plotDeltaGraph(deltaType):
        ...
        fig.update_layout(
            title={
                'text': "Relative to Max Verstappen",
                'y':0.95,
                'x':0.5,
                'xanchor': 'center',
                'yanchor': 'top'})
